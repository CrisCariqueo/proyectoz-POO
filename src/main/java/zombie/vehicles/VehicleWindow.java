        ...
        if (var1 > 0) {
            if (this.isHittable()) {
                if (GameClient.bClient) {
                    GameClient.instance.sendClientCommandV((IsoPlayer)null, "vehicle", "damageWindow", new Object[]{"vehicle", this.part.vehicle.getId(), "part", this.part.getId(), "amount", var1});
                } else {
