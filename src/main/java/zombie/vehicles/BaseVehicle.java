...
public final class BaseVehicle extends IsoMovingObject implements Thumpable, IFMODParameterUpdater {
    ...
    public void save(ByteBuffer var1, boolean var2) throws IOException {
        ...
        GameWindow.WriteString(var1, (String)null);
    ...
    private void applyImpulseFromProneCharacters() {
        if ((!GameClient.bClient || this.hasAuthorization(GameClient.connection)) && !GameServer.bServer) {
            boolean var1 = PZArrayUtil.contains(this.impulseFromSquishedZombie, (var0) -> {
    ...
    public void crash(float var1, boolean var2) {
        if (GameClient.bClient) {
            ...
            GameClient.instance.sendClientCommandV((IsoPlayer)null, "vehicle", "crash", new Object[]{"vehicle", this.getId(), "amount", var1, "front", var2});
        } else {
            float var3 = 1.3F;
            float var4 = var1;
    ...
    public void tryHotwire(int var1) {
        ...
        if (var6 != null) {
            if (GameServer.bServer) {
                GlobalObject.playServerSound(var6, this.square);
        ...
        if (!GameClient.bClient) {
            ...
            if (var3 == null) {
                ...
                if (var1 && Rand.Next(100) <= 8 && !var3.Specific.isEmpty()) {
                    var4 = (ItemPickerJava.ItemPickerRoom)PZArrayUtil.pickRandom(var3.Specific);
                } else {
                    var4 = var3.Normal;
                }
