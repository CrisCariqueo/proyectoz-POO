...
public final class VehiclePart extends Clipper implements ChatElementOwner, WaveSignalDevice {
    ...
    public void setGeneralCondition(InventoryItem var1, float var2, float var3) {
        ...
        if (var1 != null) {
            ...
            if (var6 > 0 && Rand.Next(100) < var6) {
                var5 = (float)Rand.Next(var4 - var4 / 2, var4);
            }
        } else {
            byte var7 = 30;
            var6 = (int)((float)var7 + var3);
            if (Rand.Next(100) < var6) {
                var5 = Rand.Next((float)var4 * 0.5F, (float)var4);
            }
        }
