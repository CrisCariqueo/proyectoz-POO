...
import org.example.BaseVehicle.Authorization;
import org.example.BaseVehicle.engineStateTypes;
...
public final class VehicleManager {
    ...
    public void serverUpdate() {
        ...
        for(var2 = 0; var2 < GameServer.udpEngine.connections.size(); ++var2) {
            ...
            this.sendVehicles(var6, PacketType.VehiclesUnreliable.getId());
    ...
    public void serverPacket(ByteBuffer var1, UdpConnection var2, short var3) {
        ...
        switch (var4) {
            ...
            case 2:
                ...
                var19 = this.IDToVehicle.get(var5);
                if (var19 == null) {
                    DebugLog.Vehicle.warn("Vehicle vid=%d not found", new Object[]{var5});
                } else {
                    var26 = (IsoPlayer)GameServer.IDToPlayerMap.get(var17);
                    if (var26 == null) {
                        DebugLog.Vehicle.warn("Player pid=%d not found", new Object[]{var17});
                    } else {
                        ...
                        if (var27 != null && var27 != var26) {
                            ...
                            if (var18 == 0 && var19.isNetPlayerAuthorization(Authorization.Server)) {
                ...
                if (var25 == null) {
                    ...
                    if (var27 == null) {
                        ...
                        if (var11 != null && var11 != var27) {
                            ...
                            if (var24 == 0 && var25.isNetPlayerAuthorization(Authorization.Server)) {
    ...
    private void clientReceiveUpdateFull(ByteBuffer var1, short var2, float var3, float var4, float var5) throws IOException {
        BaseVehicle.Authorization var6 = Authorization.valueOf(var1.get());
                ...
                if ((var3 & 1) != 0) {
                    ...
                    if ((var3 & 4) != 0) {
                        ...
                        if (var10 >= 0 && var10 < engineStateTypes.Values.length) {
                            switch (engineStateTypes.Values[var10]) {
                                case Idle:
                                    var9.engineDoIdle();
                                case Starting:
                                default:
    ...
    public void clientPacket(ByteBuffer var1) {
        ...
        switch (var2) {
            ...
            case 2:
                ...
                var22 = this.IDToVehicle.get(var3);
                if (var22 == null) {
                    DebugLog.Vehicle.warn("Vehicle vid=%d not found", new Object[]{var3});
                } else {
                    var27 = (IsoPlayer)GameClient.IDToPlayerMap.get(var15);
                    if (var27 == null) {
                        DebugLog.Vehicle.warn("Player pid=%d not found", new Object[]{var15});
                    } else {
    ...
    public void sendPhysic(BaseVehicle var1) {
        ByteBufferWriter var2 = GameClient.connection.startPacket();
        PacketTypes.PacketType var3 = var1.isReliable ? PacketType.Vehicles : PacketType.VehiclesUnreliable;
        var3.doPacket(var2);
        var2.bb.put((byte)9);
